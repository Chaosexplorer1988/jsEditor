(function() {
  "use strict";
  var $, Animation, Draggable, Widget, timerId,
  ...
  Widget = (function() {
    ...
    Widget.widget = function($el, options) {
      var data;
      if (options == null) {
        options = {};
      }
      ...
      if (!data) {
        ...
        $el.data('_widget', data);

          $el.on('mouseenter', ".ui-resizable-handle", function () {
              if (timerId)
    ...
    function Widget($el, settings) {
        ...
        settings = {columns: $('.widget').data('columns')};
      ...
      this.$el = $el;
      this.settings = $.extend({}, Widget.settings, settings);
    ...
    Widget.prototype.ordinalize = function($elements) {
    ...
    Widget.prototype.reordinalize = function($element, position) {
    ...
    Widget.prototype.compare = function(d, s) {
      if (d.y > s.y + s.h) {
        return +1;
      }
      if (s.y > d.y + d.h) {
    ...
    Widget.prototype.draggable = function(method) {
    ...
    Widget.prototype.$sorted = function($elements) {
    ...
    Widget.prototype.draggingBegan = function(event) {
    ...
    Widget.prototype.draggingEnded = function(event) {
      var $elements, ref, ref1;
      $elements = this.$sorted();
      this.ordinalize($elements);
      setTimeout(this.layout, 0);
    ...
    Widget.prototype.draggingMoved = function(event) {
    ...
    Widget.prototype.structure = function($elements) {
    ...
    Widget.prototype.optimize = function(originals) {
  ...
  $.fn.extend({
    widget: function() {
      ...
      return this.each(function() {
        ...
        $this = $(this);
        options = $.extend({}, $.fn.widget.defaults, typeof option === "object" && option);
        action = typeof option === "string" ? option : option.action;
        if (action == null) {
          action = "layout";
        }
        return Widget.widget($this, options)[action](parameters);
      });
    }
  });
